...
# wmk =['00001_content', '00017_frontier_stitching', '00000_blackmarks', '00008_deepmarks', '00002_jia']
wmk = ['00003_unrelated', '00001_noise']
wm_acc = {}
for wmk_index in wmk:
    ...
    for i in range(50):
        ...
        args = [
            ...
            "--wm_dir",
            f"/home/xhe085/Proj/NEW_WMK_densenet/Watermark-Robustness-Toolbox/best_point/{wmk_index}"
        ]
        # 完整命令
    ...
    with open(f'/home/xhe085/Proj/NEW_WMK_densenet/Watermark-Robustness-Toolbox/outputs/cifar10/stability/{wmk_index}.pkl', 'wb') as file:
