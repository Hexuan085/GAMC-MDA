...
class Zhang(Watermark):
    ...
    def embed(self,
        ...
        # state_dict = torch.load('/home/xhe085/Proj/NEW_WMK_densenet/Watermark-Robustness-Toolbox/best_point/00001_content/best.pth')

        # x_wm, y_wm, x_source, y_source = state_dict['x_wm'], state_dict['y_wm'], state_dict['x_source'], state_dict['y_source']

        state_dict1 = torch.load('/home/xhe085/Proj/NEW_WMK_copy/Watermark-Robustness-Toolbox/outputs/cifar10/wm/unrelated/for_poisoning/checkpoint.pth')
        # x_wm1, y_wm1 = state_dict1['x_wm'], state_dict1['y_wm']
        x_wm, y_wm = state_dict1['x_wm'], state_dict1['y_wm']

        # state_dict2 = torch.load('/home/xhe085/Proj/NEW_WMK_densenet/Watermark-Robustness-Toolbox/best_point/00017_frontier_stitching/checkpoint.pth')
        # x_wm2, y_wm2 = state_dict2['x_wm'], state_dict2['y_wm']

        # x_wm = np.concatenate((x_wm1, x_wm2))
        # y_wm = np.concatenate((y_wm1, y_wm2))
