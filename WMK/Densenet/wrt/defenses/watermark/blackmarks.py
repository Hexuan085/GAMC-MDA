...
class Blackmarks(Watermark):
    ...
    def keygen(self,
        ...
        x_wm_1, y_wm_1, cluster_ids = self._generate_candidate_keys(wm_loader=wm_loader,
                                                                train_loader=train_loader,
                                                                encoding=self.encoding,
                                                                keylength=keylength,
                                                                key_expansion_factor=key_expansion_factor)
        x_wm, y_wm = train_loader.normalize(x_wm_1), y_wm_1
    ...
    def embed(self,
        ...
        state_dict = torch.load('/home/xhe085/Proj/NEW_WMK_densenet/Watermark-Robustness-Toolbox/best_point/00000_blackmarks/best.pth')
        x_wm, y_wm, self.encoding, train_signature, signature  = state_dict['x_wm_1'], state_dict['y_wm_1'], state_dict['encoding'], state_dict['train_signature_1'], state_dict['y_wm'] 
        # print('y_wm_1',y_wm)
        ...
        y_wm_0 = y_wm
        print(y_wm)
        train_signature_1 = train_signature
        ...
        if output_dir is not None:
            checkpoint = {
                ...
                'x_wm_1': x_wm_1,
                'y_wm_1': y_wm_0,
                'train_signature_1': train_signature_1,
                'x_wm': x_wm,
                'y_wm': signature
            }
