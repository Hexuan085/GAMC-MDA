...
class Deepmarks(Watermark):
    ...
    def embed(self,
        ...
        state_dict = torch.load('/home/xhe085/Proj/NEW_WMK_densenet/Watermark-Robustness-Toolbox/best_point/00008_deepmarks/best.pth')
        x_wm, signature  = state_dict['x_wm'], state_dict['signature']
