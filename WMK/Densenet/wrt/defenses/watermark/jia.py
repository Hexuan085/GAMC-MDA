...
class Jia(Watermark):
    ...
    def embed(self,
        ...
        state_dict = torch.load('/home/xhe085/Proj/NEW_WMK_densenet/Watermark-Robustness-Toolbox/best_point/00002_jia/best.pth')
        wm_data  = state_dict['wm_data']
...
def wm_jia_embed(defense: Jia,
    ...
    """
    wm_loader_target = instantiate(config.wm_dataset_target)
