...
class Zhang(Watermark):
    ...
    def embed(self,
        ...
        state_dict2 = torch.load('/home/xhe085/Proj/NEW_WMK_copy/Watermark-Robustness-Toolbox/best_point/00005_unrelated/checkpoint.pth')
        ...
        # x_source, y_source = state_dict2['x_source'], state_dict2['y_source']
        x_source_1 = x_source
