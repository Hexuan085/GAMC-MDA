...
class FrontierStitching(Watermark):
    ...
    def embed(self,
        ...
        state_dict = torch.load('/home/xhe085/Proj/NEW_WMK_copy/Watermark-Robustness-Toolbox/outputs/cifar10/wm/frontier_stitching/00002_frontier_stitching/best.pth')
        x_wm, y_wm  = state_dict['x_wm_1'], state_dict['y_wm']
